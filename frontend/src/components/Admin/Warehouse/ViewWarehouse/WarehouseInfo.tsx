...
// }
const WarehouseInfo: React.FC<props> = ({ data }) => {
        ...
        <Grid container>
          ...
          <Grid item lg={8} md={8} sm={8} xs={12}>
            <Typography variant="h6">
              {data?.name} {/* <span className={classes.activeLabel}>Active</span> */}
          ...
          <Grid item lg={4} md={4} sm={4} xs={12}>
            <div className={classes.iconSection}>
              <Button
                ...
                type="secondary"
                onClick={() => {
                  navigate(`/admin/warehouse/update/${data?.id}`);
                }}
              />
              &nbsp; &nbsp;
              <Button
      ...
      <Grid container>
        <Grid item lg={8} md={8} sm={12} xs={12}>
          <div className={classes.infoSection}>
            ...
            <Typography variant="body1">{data?.address_line_2}</Typography>
            <Typography variant="body1">
              {data?.country}, {data?.region}, {data?.city}, {data?.post_code}{" "}
            </Typography>
          </div>{" "}
        </Grid>
      </Grid>
