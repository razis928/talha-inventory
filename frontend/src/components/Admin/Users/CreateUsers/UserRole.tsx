...
const roles = [
  ...
  },
  {
    ...
    description:
      "can manage orders , customers, organizations, brands, products and users(except super admin) for all organizations"
  },
  {
...
const AddUserRole: React.FC = () => {
  ...
  const [selectedValue, setSelectedValue] = React.useState("Organization Employee");
