...
import styles from '@/app/(financial_statements)/account-receivable-customer-list/style';
import { CustomerList } from '@/utils/financials/receivables/customer-receivable-list';

interface Props {
  ledgers: CustomerList[];
}
  ...
  return (
    <div className='bg-white'>
      ...
      <PDFDownloadLink
        ...
        fileName='accounts_receivable_customer_list.pdf'
      >
        {({ url, loading }) => (
          <a
...
const LedgerPDF = ({ ledgers }: { ledgers: CustomerList[] }) => (
  <Document>
    <Page style={styles.page} size='A3'>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 4, paddingLeft: '20px' }}>
          <Text>ACCOUNTS RECEIVABLE CUSTOMER LIST</Text>
        </View>
      </View>
