...
import { AccountReceiveableSubsidaryLedger } from '@/utils/financials/receivables/receivable-subsidary-ledger';

interface Props {
  ledgers: AccountReceiveableSubsidaryLedger[];
}
...
const LedgerPDF = ({
  ...
  <Document>
    <Page style={styles.page} size='A3'>
      ...
      >
        <Text>ACCOUNTS RECEIVABLE SUBSIDIARY LEDGER</Text>
      </View>
