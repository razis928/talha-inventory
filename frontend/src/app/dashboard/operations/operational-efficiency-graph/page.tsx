...
function OperationalEfficiencyGraph() {
  const filteredData = [
    { month: 'Dept A', financialStability: 30.3675 },
    { month: 'Dept B', financialStability: 50.3675 },
    { month: 'Dept C', financialStability: 70.3675 },
    { month: 'Dept D', financialStability: 60.3675 },
  ];
...
export default OperationalEfficiencyGraph;
